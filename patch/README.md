...
`DBZ-english-v0.2.ips` is the current English patch (build v13) (experimental; may still have bugs).

Apply it with Lunar IPS, Floating IPS or `perl tools/applyips.pl rom/DB.gb patch/DBZ-english-v0.2.ips out.gb`
